...
NDefines.NAI.MAX_SAVINGS = 75 -- AI will keep a maximum of this * their monthly income in long-term savings
...
NDefines.NAI.DIPLOMATIC_INTEREST_DISTANCE = 500 -- If border distance is greater than this diplomatic AI will have less interest in the country
...
NDefines.NAI.PEACE_HIGH_WAR_EXHAUSTION_FACTOR = 2.5 -- Additional AI willingness to peace based on war exhaustion above the high threshold
...
NDefines.NAI.DIPLOMATIC_ACTION_ALLIANCE_ACCEPTANCE_MULT = 3.5 -- AI scoring for alliance based on willingness to accept it if offered to them
