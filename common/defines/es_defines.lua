...
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_1 = 250		-- Need at least this much development to upgrade to government rank 2
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_2 = 500		-- Need at least this much development to upgrade to government rank 3
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_3 = 750		-- Need at least this much development to upgrade to government rank 4
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_4 = 1000		-- Need at least this much development to upgrade to government rank 5
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_5 = 1250	-- Need at least this much development to upgrade to government rank 6
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_6 = 1500		-- Need at least this much development to upgrade to government rank 7
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_7 = 1750	-- Need at least this much development to upgrade to government rank 8
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_8 = 2000		-- Need at least this much development to upgrade to government rank 9
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_9 = 2250		-- Need at least this much development to upgrade to government rank 10
NDefines.NCountry.MIN_DEVELOPMENT_FOR_GOV_RANK_10 = 2500		-- Need at least this much development to upgrade to government rank 3
...
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_1 = 120		-- Provinces for circumnavigation (coast of gambia)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_2 = 177			-- Provinces for circumnavigation (magellan strait)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_3 = 676			-- Provinces for circumnavigation (hawaii sea)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_4 = 77			-- Provinces for circumnavigation (hawaii sea)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_5 = 58			-- Provinces for circumnavigation (hawaii sea)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_6 = 106			-- Provinces for circumnavigation (cape of good hope)
...
NDefines.NCountry.LEGITIMACY_DYNASTY_CHANGE = 0					-- Legitimacy a new dynasty starts out with
...
NDefines.NCountry.REVOLT_TECH_MORALE = 0.025			-- 1% per tech level
...
NDefines.NCountry.TERRITORY_PENALTY_CAP = 50				-- How many territories maximum can penalize you
...
NDefines.NEconomy.MISSIONARY_MAINTENANCE_FACTOR = 5				-- _EDEF_MISSIONARY_MAINTENANCE_FACTOR_
...
NDefines.NAI.DIPLOMATIC_ACTION_TAKE_ON_DEBT_BASE_FACTOR = 0 -- AI base scoring for Take on Foreign Debt (needs to be ally or block rival/power balance threat to even apply).
...
NDefines.NAI.SUBSIDY_YEARS = 20 -- Years AI will give subsidies for
NDefines.NAI.MIN_INCOME_FOR_SUBSIDIES = 20 -- Minimum monthly income for AI to want to spend some on subsidies
...
NDefines.NAI.AGGRESSIVENESS_BONUS_EASY_WAR = 300 -- Added to aggressiveness if the war is against a weak or particularily hated enemy
...
NDefines.NAI.FORCE_COMPOSITION_CHANGE_TECH_LEVEL = 11 -- Tech level at which AI will double its artillery fraction
...
NDefines.NAI.COLONY_BUDGET_FRACTION = 0.4 -- AI will spend a maximum of this amount of monthly ducats for colonies.
...
NDefines.NAI.CONQUEST_INTEREST_DISTANCE = 100 -- Beyond this range AI is less interested in conquest of provinces
...
NDefines.NAI.CALL_IN_ALLIES_POWER_RATIO = 4.0 -- AI will only call in allies in an offensive war if their military power ratio to the enemy is less than this
...
NDefines.NAI.PEACE_CALL_FOR_PEACE_FACTOR = 3	-- How much AI wants peace based on having call for peace
...
NDefines.NAI.DIPLOMATIC_ACTION_ALLIANCE_ACCEPTANCE_MULT = 3.0 -- AI scoring for alliance based on willingness to accept it if offered to them
NDefines.NAI.DIPLOMATIC_ACTION_KNOWLEDGE_SHARING_ACCEPTANCE_MULT = 3.0 -- AI scoring for knowledge sharing based on willingness to accept it if offered to them
...
NDefines.NAI.DIPLOMATIC_ACTION_ROYAL_MARRIAGE_ACCEPTANCE_MULT = 2.0 -- AI scoring for royal marriage based on their willingness to accept it if offered to them
...
NDefines.NAI.DIPLOMATIC_ACTION_MILITARY_ACCESS_EXISTING_RELATION_MULT = 2.0 -- AI scoring for military access is multiplied by this if it has an existing power cost relation
NDefines.NAI.DIPLOMATIC_ACTION_MILITARY_ACCESS_ENEMY_REGIMENTS_FACTOR = 20.0 -- AI scoring for military access is increased by this for each enemy regiment they are sheltering
...
NDefines.NAI.DIPLOMATIC_ACTION_TRADE_POWER_ACCEPTANCE_MULT = 3.0 -- AI scoring for transfer trade power based on willingness to accept it if offered to them
NDefines.NAI.DIPLOMATIC_ACTION_STEER_TRADE_ACCEPTANCE_MULT = 3.0 -- AI scoring to retain trade steering based on willingness to accept it if offered to them
...
NDefines.NAI.CHARTER_COMPANY_DEVELOPMENT_RELUCTANCE = 3				-- How much development needed to add one reluctance
